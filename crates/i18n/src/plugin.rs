...
//! This also means it forces the global `Lazy` to initialise on startup rather than midway a frame.
use bevy::app::App;
use bevy::prelude::{Plugin, error, info};
...
impl Plugin for I18nPlugin {
    fn build(&self, _app: &mut App) {
        match crate::LOCALE.initialise_language(&self.language) {
